...
/*
	        // Insert a file
	        String string = " afiheiseiajgliglasfjasljlsekfjea";
	        File body = new File();
	        body.setTitle("Test File3");
	        body.setDescription(string);

	        java.io.File fileContent = new java.io.File("TextFile.txt");
